...
#
test ".$TOMCAT_USER" = . && TOMCAT_USER=$(whoami)
...
# Starting
clear;
echo -e "\e[1mApache Tomcat Server\e[0m
\tVersion : 9.0.34
\tStatus  : \e[1m\e[93mStarting\e[5m...\e[0m\n"
...
echo -e "\e[1mApache Tomcat Server\e[0m
\tVersion : 9.0.34
\tStatus  : \e[1m\e[92mRunning\e[0m\n\nPress '\e[1mq\e[0m' to stop" 

while read -n1 -s -r key; do
if [[ $key == 'q' ]]; then
  break;
fi
done
...
echo -e "\e[1mApache Tomcat Server\e[0m
\tVersion : 9.0.34
\tStatus  : \e[1m\e[93mStopping\e[5m...\e[0m\n"
